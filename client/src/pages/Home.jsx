...
function Home() {
  ...
  return (
    <div>
      {/* top */}
      <div className="flex flex-col gap-6 p-28 px-3 max-w6xl">
        <h1 className="text-gray-600 font-bold text-3xl lg:text-6xl">
          Find yourself next <span className="text-slate-500"> perfect </span>
          place to live <br />
          with ease
        </h1>
        ...
        {offerListings &&
          ...
          offerListings.map((listing) => (
            <SwiperSlide key={listing._id}>
              <div
                style={{
                  background: `url(${listing.imageUrls && listing.imageUrls[0]}) center no-repeat`,
